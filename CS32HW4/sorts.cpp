...
//  CS32 HW 4
//
//  Created by Caden McQuillen on 5/27/19.
...
int main()
{
    ...
    // destruction time.
    {
        ...
        auxPointers.resize(auxSensors.size());
        for(int i = 0; i<auxSensors.size(); i++)
        {
            auxPointers[i]= &auxSensors[i];
        }
        ...
        for(int i = 0; i < auxPointers.size(); i++)
        {
            sensors[i] = *auxPointers[i];
        }
